...
namespace Car_Racing_Game
{
    public partial class Form1 : Form
    {
        ...
        int collectedcoin = 0; // skupljeni novcici 
        ...
        private void lbl_restart_Click(object sender, EventArgs e)
        {
            timer1.Start();
            Game_menu.Hide();   
            car.Location = new Point(103, 379);
            enemy1.Location = new Point(38,43);
            enemy2.Location = new Point(175,122);
            enemy3.Location = new Point(273,22);
